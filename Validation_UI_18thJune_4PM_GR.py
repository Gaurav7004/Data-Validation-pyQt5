...
class Ui_Dialog(object):
    ...
    def summaryReport(self):
        ...
        if FType == 'Health Sub Centre':
            ...
            final_result = pd.DataFrame({"Conditions": df_SummReport.columns,
    ...
    def export(self):
        table_result = self.summaryReport()
        ...
        with pd.ExcelWriter(filename) as writer:  # doctest: +SKIP
            ...
            table_result.to_excel(writer, sheet_name='Summary Report')
