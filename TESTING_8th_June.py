...
class Ui_Dialog(object):
    ...
    def VerifyFType(self):
        ...
        try:
            if (FType == 'Health Sub Centre'):
                ...
                self.pushButton_2.clicked.connect(self.PHC_Validate)
    ...
    def PHC_Validate(self):
        ...
        df = pd.concat([df['9.1.1(103) <= 4.1.1.a(56) + 4.1.1.b(57)'],
                        ...
                        df['3.1.1(55) <= 2.2(51)'],
                        df['3.1(54) <= 2.2(51)'],
                        df['4.1.2(58) <= 4.1.1.a(56) + 4.1.1.b(57)']], axis=1)
    ...
    def onSelectFacilityName(self, index):
        ...
        scroll = QtWidgets.QScrollBar(Dialog)
    ...
    def export(self):
        ...
        msg.setText(("{}\n\n and \n\n {}  \n\n exported to the file location you have chosen".format(
            filename, filename1)))
        msg.exec()
